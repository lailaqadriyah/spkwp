...
if ($search !== '') {
    ...
    $whereClause = "WHERE id_les LIKE '%$search%' OR nm_les LIKE '%$search%' OR kode_alternatif LIKE '%$search%'";
}

$hasil = count(Index("SELECT * FROM alternatif $whereClause"));
$total = ceil($hasil / $halaman);
$data = Index("SELECT * FROM alternatif $whereClause LIMIT $awal,$halaman");
?>
                                    ...
                                    <div class="card-header-icon" style="width: 100%;">
                                        <div class="is-flex is-align-items-center is-justify-content-flex-end" style="width: 100%;">
                                            <form method="GET" action="index.php" class="field has-addons mb-0">
                                                <input type="hidden" name="halaman" value="datales">
                                                <div class="control">
                                                    <input class="input" type="text" name="search" placeholder="Cari nama kos..." value="<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>">
                                                </div>
                                                <div class="control">
                                            ...
                                            <a class="button is-maroon ml-3" href="index.php?halaman=tambahdatales">
                                    ...
                                    <div class="table-container">
                                        <table class="table is-fullwidth">
                                            ...
                                            <tbody>
                                                ...
                                                <?php if (empty($data)) : ?>
                                                    <tr>
                                                        <td colspan="4" class="has-text-centered">Data tidak ditemukan.</td>
                                                    </tr>
                                                <?php else : ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="buttons">
                                                                    ...
                                                                    <button class="button is-maroon" onclick="DeleteData(<?= $row['id_les']; ?>)">
